  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl w-full z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
        ...
        {/* Left Side: Handcrafted Viewfinder Graphic */}
        <div className="lg:col-span-5 flex justify-center items-center order-2 lg:order-1">
          <motion.div
            ...
            className="w-full max-w-[380px] aspect-square rounded-3xl border border-slate-200/80 bg-white shadow-xl shadow-slate-100 p-6 relative overflow-hidden flex flex-col justify-between"
          >
            {/* Ambient inner gradients */}
            <div className="absolute inset-0 bg-gradient-to-tr from-green-500/5 via-transparent to-emerald-500/5 pointer-events-none" />
            
            {/* Viewfinder crosshairs and margins */}
            <div className="absolute inset-4 border border-dashed border-slate-200/60 pointer-events-none flex items-center justify-center">
              {/* Center Crosshair */}
              <div className="w-4 h-4 relative">
                <div className="absolute top-1/2 left-0 w-4 h-[1px] bg-slate-300 -translate-y-1/2" />
                <div className="absolute top-0 left-1/2 h-4 w-[1px] bg-slate-300 -translate-x-1/2" />
              </div>
            </div>

            {/* Viewfinder top indicators */}
            <div className="flex justify-between items-start font-mono text-[9px] text-slate-500 relative z-10">
              <div className="flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded-full bg-red-500 animate-ping" />
                <span className="text-slate-800 font-bold">REC</span>
              </div>
              <div>tc 00:14:52:12</div>
            </div>

            {/* Viewfinder Center Graphic: Circular Lens rings */}
            <div className="relative w-44 h-44 rounded-full border border-slate-200 mx-auto flex items-center justify-center">
              <motion.div 
                animate={{ rotate: 360 }}
              ...
              <motion.div 
                ...
                className="absolute inset-6 rounded-full border border-slate-100 flex items-center justify-center" 
              >
                <div className="text-[10px] font-mono text-green-600 uppercase tracking-widest font-semibold">
                  GOPI.EDIT
                </div>
              </motion.div>
              {/* Outer corner marks */}
            ...
            {/* Viewfinder bottom metrics */}
            <div className="flex justify-between items-end font-mono text-[9px] text-slate-500 relative z-10">
              <div>
                <p>SHUTTER: 1/50</p>
              ...
              <div className="text-right">
                <p>FOCAL: 35MM</p>
                <p className="mt-0.5 text-green-600 font-semibold">AF-C</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="lg:col-span-7 flex flex-col justify-center text-left order-1 lg:order-2">
          ...
          <p className="font-general text-base md:text-lg text-slate-700 leading-relaxed mb-6 font-medium">
            I don't just splice clips together. I sculpt visual narratives that sync movement and sound to produce raw emotion.
          </p>

          <p className="font-general text-slate-600 text-sm md:text-base leading-relaxed mb-6">
            Based in India, I edit videos for global brands, record labels, and top-tier creators. My focus is short-form social content that breaks the scroll, high-energy music videos that command attention, and cinematic commercials that tell deep stories.
          </p>

          <p className="font-general text-slate-600 text-sm md:text-base leading-relaxed">
            Every transition, color grade, and sound effect is placed intentionally to guide the viewer’s eye and keep their eyes glued to the screen. If it doesn't evoke a feeling, it gets cut.
          </p>
